...
public class RecursiveCalcRatingEagerUseFirstPlaceStep_SolvingC implements BuildStep {
    ...
    public RecursiveCalcRatingEagerUseFirstPlaceStep_SolvingC(PizzaBuilder pizzaBuilder) {
...
//                    System.out.println(pizza);
            ...
            if (foundSize && pizza.canPlace(slice))
                break;
